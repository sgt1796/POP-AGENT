...
def test_runtime_overrides_backward_compat(monkeypatch):
    ...
    monkeypatch.setattr(runtime, "FileReadTool", lambda workspace_root, **kwargs: _dummy_tool("file_read"))
    monkeypatch.setattr(runtime, "FileWriteTool", lambda workspace_root, **kwargs: _dummy_tool("file_write"))
    monkeypatch.setattr(runtime, "DownloadUrlToFileTool", lambda workspace_root, **kwargs: _dummy_tool("download_url_to_file"))
    ...
    monkeypatch.setattr(runtime, "AgentMailSendTool", lambda workspace_root, **kwargs: _dummy_tool("agentmail_send"))
    ...
    monkeypatch.setattr(runtime, "OpenAlexWorksTool", lambda: _dummy_tool("openalex_works"))
